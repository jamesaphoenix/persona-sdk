import { NormalDistribution, UniformDistribution, ExponentialDistribution, BetaDistribution } from '../distributions';
/**
...
export class DistributionFitter {
     ...
     */
    async fitDistribution(variable, values, candidates) {
     ...
     */
    async fitSingleDistribution(distributionName, values) {
     ...
     */
    calculateGoodnessOfFit(values, distribution) {
     ...
     */
    approximateCDF(value, distribution) {
...
//# sourceMappingURL=distribution-fitter.js.map