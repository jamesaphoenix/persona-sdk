 ...
 */
export declare function answerExactMatch(example: Example, prediction: Prediction, _trace?: any, _frac?: number): number;
/**
 * Checks if the predicted answer appears in any of the provided passages/context
 */
export declare function answerPassageMatch(example: Example, prediction: Prediction, _trace?: any): number;
/**
 * Fuzzy answer matching using edit distance with configurable threshold
 */
export declare function answerFuzzyMatch(example: Example, prediction: Prediction, _trace?: any, threshold?: number): number;
/**
 * Checks if predicted answer contains the expected answer as a substring
 */
export declare function answerContainsMatch(example: Example, prediction: Prediction, _trace?: any): number;
/**
 * Numeric answer matching with tolerance
 */
export declare function answerNumericMatch(example: Example, prediction: Prediction, _trace?: any, tolerance?: number): number;
/**
