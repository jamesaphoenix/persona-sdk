...
- custom: Provide a formula for other relationships`;
    ...
    getTransformFunction(type, customFormula) {
        switch (type) {
            ...
            case 'custom':
                if (customFormula) {
                    return new Function('value', 'dependent', customFormula);
                }
                return (value) => value;
            default:
                return (value) => value;
     ...
     */
    getAttributeDescription(spec) {
        if (typeof spec === 'string')
            return `fixed value: ${spec}`;
        if (typeof spec === 'number')
            return `fixed value: ${spec}`;
        if (typeof spec === 'boolean')
            return `fixed value: ${spec}`;
...
//# sourceMappingURL=auto-correlation-generator.js.map