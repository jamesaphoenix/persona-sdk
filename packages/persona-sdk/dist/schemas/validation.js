...
export const validatePersonaGroup = (data) => {
 ...
 */
export const safeParsePersona = (data) => {
    return PersonaSchema.safeParse(data);
};
export const safeParsePersonaGroup = (data) => {
    return PersonaGroupSchema.safeParse(data);
};
export const safeParseDistribution = (data) => {
