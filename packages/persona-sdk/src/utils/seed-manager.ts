...
export class SeedManager {
  ...
  private rngs: Map<string, SeededRNG> = new Map();
   ...
   */
  static random(context: string = 'default'): number {
   ...
   */
  static setTestSeed(seed: number = 12345): void {
 ...
 */
export const testWithSeed = (name: string, fn: () => void | Promise<void>, seed: number = 12345) => {
  return {
    name,
    fn: async () => {
...
export class DeterministicRandom {
   ...
   */
  static normal(mean: number = 0, stdDev: number = 1, context: string = 'test'): number {
   ...
   */
  static uniform(min: number = 0, max: number = 1, context: string = 'test'): number {
   ...
   */
  static exponential(lambda: number = 1, context: string = 'test'): number {
   ...
   */
  static beta(alpha: number, beta: number, context: string = 'test'): number {
   ...
   */
  static gamma(shape: number, context: string = 'test'): number {
    if (shape < 1) {
   ...
   */
  static categorical<T>(items: T[], weights: number[], context: string = 'test'): T {
