...
import { BootstrapOptimizer } from '../src/optimizers/bootstrap.js';
import { ExactMatch, FuzzyMatch } from '../src/metrics/index.js';
import { 
  mathDataset, 
  qaDataset,
...
import type { BootstrapConfig, OptimizationResult } from '../src/types/index.js';
